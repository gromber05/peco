        ...
        Room.databaseBuilder(
            ...
            .addCallback(object : RoomDatabase.Callback() {
                override fun onCreate(db: SupportSQLiteDatabase) {
                    ...
                    db.execSQL("""
                        INSERT INTO animals (id, name, species, photo, dob, latitude, longitude, adoptionState, volunteerId)
                        VALUES (1, 'Luna', 'Perro',
                        'https://eq2imhfmrcc.exactdn.com/wp-content/uploads/2016/08/golden-retriever.jpg?strip=all',
                        '2022-03-01', 36.5271, -6.2886, 'AVAILABLE', 2)
                    """.trimIndent())
                        ...
                        '2021-07-12', 36.6864, -6.1372, 'AVAILABLE', 2)
                    """.trimIndent())
                        ...
                        '2020-11-05', 36.4657, -6.1967, 'AVAILABLE', 2)
                    """.trimIndent())

                                        db.execSQL("""
                        INSERT INTO animals (id, name, species, photo, dob, latitude, longitude, adoptionState, volunteerId)
                        VALUES (4, 'Simba', 'Gato',
                        'https://i.pinimg.com/736x/9a/bf/f2/9abff24eab348a5394c6b90225768242.jpg',
                        '2019-09-20', 36.5297, -6.2923, 'AVAILABLE', 2)
                    """.trimIndent())
                }
            })
